<%@ Page Title="" Language="C#" MasterPageFile="ACMasterPage.master" AutoEventWireup="true" CodeFile="KYCDetail.aspx.cs" Inherits="AC_KYCDetail" %>
...
<div class="form-row">
  ...
  <asp:Label ID="lblMsg" runat="server" Font-Bold="True" Font-Size="14pt" ForeColor="#0066FF"></asp:Label>
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
            ...
            DataKeyNames="BiharRegNo" AutoGenerateColumns="false"   onpageindexchanging="gvdata_PageIndexChanging" Font-Size="12px">
            <Columns>
