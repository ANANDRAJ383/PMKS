...
public partial class DAO_ITR_ReturnRecoveryForm : System.Web.UI.Page
{
    ...
    void BindData()
    {
        try
        {
            objcls.storeProcedure.NewStoreProcedure("SP_GetFarmerData_tbl_IneligibleData");
            objcls.storeProcedure.FieldName = "DistCode,BlockCode,PanchayatCode,DBTRegistrationID";
    ...
    protected void btnViewDetail_Click(object sender, EventArgs e)
    {
        ...
        WinOpen("IneligibleDone.aspx?RegId=" + RegId.Trim() + "&PMKRegId=" + PMKRegId.Trim());
