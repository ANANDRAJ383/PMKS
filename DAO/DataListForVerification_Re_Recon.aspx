<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="DataListForVerification_Re_Recon.aspx.cs" Inherits="DAO_DataListForVerification_Re_Recon" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 22px; color: #000; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">Verification of Re-reconsider Application</div><br />
...
<div class="form-row">
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
                AllowPaging="false"  CssClass="table table-bordered table-responsive table-striped"
