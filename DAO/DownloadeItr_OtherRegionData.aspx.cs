...
public partial class CSC_DownloadeKYCData : System.Web.UI.Page
{
    ...
    void DownloadITRData()
    {
        try
        {
            objcls.storeProcedure.NewStoreProcedure("[SP_Download_ItrReturn_Data]");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", ddlPanchayat.SelectedItem.Text + "_ITRCData.xls"));
    ...
    void DownloadOtherData()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Response.Buffer = true;
                Response.ClearContent();
                Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", ddlPanchayat.SelectedItem.Text + "_Other_Resion.xls"));
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                StringWriter sw = new StringWriter();
                HtmlTextWriter htw = new HtmlTextWriter(sw);
                grv.RenderControl(htw);
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Utility.showMessage(this, "Please Chosse the Resion");
        }
