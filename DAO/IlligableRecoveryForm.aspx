<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="IlligableRecoveryForm.aspx.cs" Inherits="DAO_ITR_ReturnRecoveryForm" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 22px; color: #000; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">पी० एम० किसान (अयोग्य किसान)<br />लाभुकों से वापस की गई राशि विवरण की प्रविष्टि करने हेतु </div><br />
...
<div class="form-row">
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
                AllowPaging="true" CssClass="mydatagrid" PagerStyle-CssClass="pager"
 HeaderStyle-CssClass="header" RowStyle-CssClass="rows" PageSize="30"
            DataKeyNames="RegistrationId,reg_no" AutoGenerateColumns="false"   onpageindexchanging="gvdata_PageIndexChanging" Font-Size="12px">
            <Columns>
               ...
               <asp:TemplateField HeaderText="वापस करने का विवरण" Visible="false">
                    ...
                    Control="txtTRDate" Format="dd mmm yyyy" To-Today="true" From-Date="01-01-2018"/>
 ...
 <table class="table-bordered table-responsive table table-striped " style="width: 100%; background-color :#2a5197 ; color: White;"  align="center" id="tblBulk" runat="server" visible="false" >
        <tr>
            <td ><asp:CheckBox ID="CheckBox2" runat="server"  /> &nbsp;&nbsp;</td>
            <td>उपरोक्त जानकारी सही है एवं सत्यापन किया जा सकता है ।</td>
            <%--<td >Upload letter:  ** Upload file only PDF/pdf  <asp:FileUpload ID="flu" runat="server" /> </td>--%>
            <td >
                <asp:Button ID="bnSave" runat="server" Text="सत्यापित एवं सुरक्षित करें"   class="btn btn-success" OnClick="bnSave_Click" Height="69px"  /> </td>
        </tr>
    </table>
</asp:Content>
