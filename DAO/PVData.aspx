<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="PVData.aspx.cs" Inherits="DAO_PVData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
            ...
            DataKeyNames="RegistrationNo" AutoGenerateColumns="false"   
            onpageindexchanging="gvdata_PageIndexChanging" Font-Size="10px" >
            <Columns>
