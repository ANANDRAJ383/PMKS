<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IneligibleDone.aspx.cs" Inherits="DAO_ITRDone" %>
...
<body style="background-color: #5ed07c;">
    <form id="form1" runat="server" >
        ...
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">पी० एम० किसान (अयोग्य (Ineligible) दाता किसान)<br />भुगतान वापस करने हेतु विपत्र </div><br />
