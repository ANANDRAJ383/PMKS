<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="VerifyFarmerRe_Recon.aspx.cs" Inherits="DAO_VerifyFarmerRe_Recon" %>
        ...
        <tr>
          ...
          <tr>
            <td>5. आवेदक योजना के दिशा-निर्देश के अनुसार योग्य पाए गए|</td>
              <td> <asp:RadioButtonList ID="rb5" runat="server" RepeatDirection="Horizontal" Width="100%" OnSelectedIndexChanged="rb5_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem >Yes</asp:ListItem>
                        <asp:ListItem >No</asp:ListItem>
                    </asp:RadioButtonList>
