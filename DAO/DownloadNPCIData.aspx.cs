...
public partial class CSC_DownloadeKYCData : System.Web.UI.Page
{
    ...
    void DownloadData()
    {
        try
        {
            objcls.storeProcedure.NewStoreProcedure("SP_GetNPCIData");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", ddlPanchayat.SelectedItem.Text + "_NPCIData.xls"));
