<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="DAO_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	 ...
	 <div class="my-5" >
				<div class="">
					<div style="text-align: center" class="bg-light p-4 b-dbcard"><h1>पुनर्विचार</h1>
	...
	<div class="my-5" >
				<div >
<div style="text-align: center" class="bg-light p-4 b-dbcard"><h1>पुनः विचार</h1>
