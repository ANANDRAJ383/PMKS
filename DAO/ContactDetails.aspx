<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="ContactDetails.aspx.cs" Inherits="HQ_ContactDetails" %>
        ...
        <div class="input-group mb-3 col-lg-2">
         ...
         <div class="input-group mb-3 col-lg-3">
            ...
            <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-select" ValidationGroup="s">
                ...
                <asp:ListItem Value ="SAO" Text="SAO"></asp:ListItem>
                
            </asp:DropDownList>
              </div>
         <div class="input-group mb-3 col-lg-2" style="left: 0px; top: -1753px">
             &nbsp;
