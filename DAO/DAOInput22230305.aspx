<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="DAOInput22230305.aspx.cs" Inherits="DAO_DAOInput2223" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #1C6794; padding: 5px; margin-top: 5px; width: 100%;" align="center">Verify Input Subsidy Data 2022-23 of District :- <asp:Label ID="lblDistrict" runat="server"></asp:Label></div><br />
  ...
  <asp:Button ID="btnShow" runat="server" Text="Show" CssClass="btn btn-success" OnClick="btnShow_Click"  /> 
     ...
     <div class="input-group mb-3 col-lg-12" align="center">
      ...
      <div align="center">
          ...
          <br />
           <asp:Label ID="Label2" runat="server" ForeColor="#FF3300" Text="आंकड़ो को सत्यापित करने,भूमि दस्तावेज देखने के लिये कृपया चेकबॉक्स को चेक करें" Visible="true"></asp:Label> <br />
          <asp:Label ID="Label1" runat="server" ForeColor="#FF3300"></asp:Label> 
        <asp:LinkButton ID="lnbDownloadExcel" runat="server" Text="Download Excel"  Font-Bold="true"  Visible="false"></asp:LinkButton></div>
        <div>
            ...
            DataKeyNames="Registration_ID,Application_ID" AutoGenerateColumns="false" Width="100%"  AlternatingRowStyle-CssClass="alt" 
               Font-Size="10px" CssClass="Grid" OnPageIndexChanging="gvdata_PageIndexChanging"  >
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="Farmer Detail"  >
                    <ItemTemplate>
                        ...
                        <strong>Application ID : </strong> <asp:LinkButton ID="lnkAppId" runat="server" Text='<%#Bind("Application_ID") %>' CommandArgument='<%#Bind("Application_ID") %>' CommandName="view" OnClick="lnkAppId_Click"></asp:LinkButton><br />
                ...
                <asp:TemplateField HeaderText="AC Approved Status">
                    <ItemTemplate>
                        <strong>Change Rakwa :- </strong><asp:Label ID="lblApprovedRakwa" runat="server" Text='<%#Bind("ac_changerakwa") %>'></asp:Label><br />
                        <strong>Change Amount :- </strong><asp:Label ID="lblApprovedSubsidyAmount" runat="server" Text='<%#Bind("ac_changeamount") %>'></asp:Label><br />
...
<asp:LinkButton ID="lnkRead" runat="server" Text="✉ View" CommandArgument = '<%# Eval("LandPath") %>'  Font-Size="18px" OnClick="lnkRead_Click1"></asp:LinkButton>                       
                ...
                <asp:TemplateField HeaderText="DAO Remarks">
                    <ItemTemplate>
                        <strong>Status :- </strong><asp:DropDownList ID="ddlApproved" runat="server" Width="100px" AutoPostBack="True" OnSelectedIndexChanged="ddlApproved_SelectedIndexChanged"  >
                                 ...
                                 <br />
                         <strong>Reject Cause :- </strong><asp:DropDownList ID="DropDownList1" runat="server" Width="100px" AutoPostBack="True" Enabled="false" >
                                 ...
                                 <br />
                        <strong>Approved Amount :- </strong><asp:TextBox  ID="txtDAOApprovedAmount"  runat="server"  AutoPostBack="true"
           ...
           <asp:TemplateField HeaderText="View Details">
                <ItemTemplate>
                    <asp:Button ID="btnLandDetail" Text="View Land Detail" runat="server" OnClick="btnLandDetail_Click"  class="btn btn-success"/><br />
