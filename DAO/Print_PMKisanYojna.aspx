<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="Print_PMKisanYojna.aspx.cs" Inherits="Print_PMKisan" %>
...
&nbsp;Pradhan Mantri KIsan SAmman Nidhi Yojna(PM-KISAN)<asp:Image ID="Image2" runat="server" Height="62px" ImageUrl="~/Images/bihar_sarkar.png" Width="60px" />
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body" style="font-size: 12px;">
                <div>किसान का प्रकार:<asp:Label ID="ddlKisanType" runat="server" Width="150px" Font-Bold="True" Font-Size="13px" ForeColor="Red"></asp:Label></div>
