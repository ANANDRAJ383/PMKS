<%@ Page Title="" Language="C#" MasterPageFile="DAOMasterPage.master" AutoEventWireup="true" CodeFile="SocialAuditData_Illigable.aspx.cs" Inherits="SocialAuditData_Illigable" EnableEventValidation = "false" %>
  ...
  <asp:Button ID="btnShow" runat="server" Text="Show" CssClass="btn btn-success" OnClick="btnShow_Click"  /> 
        ...
        <table class="table-bordered  table table-striped " style="width: 98%; margin-left:10px;">
         <tr>
             ...
             <td>
                 <asp:Button ID="btnExport" runat="server" Text="Export To Excel" CssClass="btn btn-success"  OnClick="btnExport_Click"  Visible="false"/>
             </td>
         </tr>
