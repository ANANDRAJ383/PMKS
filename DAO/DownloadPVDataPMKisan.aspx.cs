...
public partial class CSC_DownloadeKYCData : System.Web.UI.Page
{
    ...
    void DownloadData()
    {
        try
        {
            objcls.storeProcedure.NewStoreProcedure("Get_PVDataForDownload_DAO_PMKISAN");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", ddlPanchayat.SelectedItem.Text + "_Panchayat_PhysicalVerificationData.xls"));
