<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="RejectedReport.aspx.cs" Inherits="RejectedReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="container-fluid">
                    <div class="d-flex clearfix mt-4">
                        <h3 class="d-inline-block" style="font-size: 32px;">Data Rejected by Govt of India Portal-District Wise Report </h3>
