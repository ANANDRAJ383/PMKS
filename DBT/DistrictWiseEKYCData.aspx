<%@ Page Title="" Language="C#" MasterPageFile="DBTMasterPage.master" AutoEventWireup="true" CodeFile="DistrictWiseEKYCData.aspx.cs" Inherits="DBT_DistrictWiseEKYCData" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">EKYC Data Report :-<asp:Button ID="Button1" runat="server" Text="Export Excel" OnClick="Button1_Click" /></div><br />
