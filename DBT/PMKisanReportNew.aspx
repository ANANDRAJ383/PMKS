<%@ Page Title="" Language="C#" MasterPageFile="DBTMasterPage.master" AutoEventWireup="true" CodeFile="PMKisanReportNew.aspx.cs" Inherits="ADM_PMKisanReport" EnableEventValidation = "false"%>
    ...
    <div class="row">
        ...
        <div class="input-group mb-3 col-lg-4">
            ...
            <asp:DropDownList ID="ddlApplicationType" runat="server" CssClass="form-select"
                ...
                <asp:ListItem Value="ORE" >Old Recon</asp:ListItem>
                <asp:ListItem Value="NRE" >New Recon</asp:ListItem>
                <%--<asp:ListItem Value="NRRE" >New Re-Recon</asp:ListItem>--%>
            </asp:DropDownList></ContentTemplate>
                        </asp:UpdatePanel> 
        </div>
