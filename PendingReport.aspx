<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="PendingReport.aspx.cs" Inherits="PendingReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="container-fluid">
                    <div class="d-flex clearfix mt-4">
                        <h3 class="d-inline-block" style="font-size: 32px;">AC Pending Report District Wise </h3>
    ...
    <asp:DropDownList ID="ddldist" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddldist_SelectedIndexChanged" class="table table-bordered mt-3" ></asp:DropDownList>

      <asp:Button ID="btnShow"  class="btn btn-danger" runat="server"  Text="Show Panchayat Wise" OnClick="btnShow_Click" ></asp:Button>
    <table class="table table-bordered mt-3">
        <tr>
            <td>
                <asp:GridView ID="grd1" runat="server" class="table table-bordered mt-3" AutoGenerateColumns="false" DataKeyNames="distcode">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="District Name" HeaderStyle-CssClass="smallSize">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkregid6" runat="server" Text='<%#Bind("DistName") %>' CommandArgument='<%#Bind("DistName") %>' CommandName="view" ForeColor="Red" Font-Size="15px" Font-Names="Verdana" Font-Bold="true"   OnClick="lnkregid_Click"></asp:LinkButton>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Greater 730 Days" HeaderStyle-CssClass="smallSize">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkregid1" runat="server" Text='<%#Bind("G730Days") %>' CommandArgument='<%#Bind("G730Days") %>' CommandName="view" ForeColor="Red" Font-Size="15px" Font-Names="Verdana" ></asp:LinkButton>
                            </ItemTemplate>
                            <HeaderStyle CssClass="smallSize" Font-Size="12px" Font-Names="Verdana" />
                        </asp:TemplateField>
                    </Columns>
