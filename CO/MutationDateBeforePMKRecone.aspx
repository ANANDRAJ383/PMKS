<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MutationDateBeforePMKRecone.aspx.cs" Inherits="CO_PMKNEW" %>
...
<body style="background-color: #5ed07c;">
    ...
    <table class="table-bordered  table table-striped " >
        ...
        <tr>
            <td>
            खाता संख्या <asp:TextBox ID="txtKhataNo" runat="server" ReadOnly="true"></asp:TextBox>
            </td>
            <td>
            खेसरा संख्या <asp:TextBox ID="txtKheraNo" runat="server" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>भूमि एकड़ <asp:TextBox ID="txtLandAkers" runat="server" ReadOnly="true"></asp:TextBox></td>
            <td>भूमि डिस्मिल <asp:TextBox ID="txtxLandDismil" runat="server" ReadOnly="true"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><asp:Button ID="bnSave" runat="server" Text="सत्यापित एवं सुरक्षित करें" class="btn btn-success" OnClick="bnSave_Click"  /> 
