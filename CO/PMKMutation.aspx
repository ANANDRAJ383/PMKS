<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PMKMutation.aspx.cs" Inherits="CO_PMKNEW" %>
    ...
    <table class="table-bordered  table table-striped " >
        ...
        <tr>
            <td>1. Select Land Transfer Detail</td>
             <td> 
                 <asp:DropDownList ID="ddlLandTransferDetail" runat="server" CssClass="form-select">
