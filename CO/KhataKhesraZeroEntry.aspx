<%@ Page Title="" Language="C#" MasterPageFile="COMasterPage.master" AutoEventWireup="true" CodeFile="KhataKhesraZeroEntry.aspx.cs" Inherits="CO_MutationDateVerification" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 22px; color: #000; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center"> Return from GOI for Entry Khata Khesra & Verify Application (Whose Khata Khesra is Zero)</div><br />
...
<div class="form-row">
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
                AllowPaging="true" PageSize="30" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mutation Date of Land (दाखिल - खारिज की तिथि 01/02/2019 से पहले (योजना की मार्गदर्शिका के अनुसार)) " HeaderStyle-ForeColor="#FF3300">
                    <ItemTemplate>
