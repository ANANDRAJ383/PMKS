...
public partial class CO_MutationDateVerification : System.Web.UI.Page
{
    ...
    void BindData()
    {
        try
        {
            objcls.storeProcedure.NewStoreProcedure("SP_Get_MutationDateEntry_tbl_PMKisan_LandSeeding_No_PMKISAN_Re");
            objcls.storeProcedure.FieldName = "DistCode,BlockCode,PanchayatCode,RegId";
