<%@ Page Title="" Language="C#" MasterPageFile="COMasterPage.master" AutoEventWireup="true" CodeFile="DataListForVerification_Re_Recon.aspx.cs" Inherits="CO_DataListForVerification_Re_Recon" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">AC Verified  List for Verification of Re-reconsider Application</div><br />
