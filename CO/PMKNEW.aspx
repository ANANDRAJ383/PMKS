<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PMKNEW.aspx.cs" Inherits="CO_PMKNEW" %>
    ...
    <table class="table-bordered  table table-striped " >
        ...
        <tr>
            <td>3. Identity of previous Owner <asp:DropDownList ID="ddlIdertity" runat="server" CssClass="form-select">
              ...
              <td> <asp:TextBox ID="txiIdentityNo" runat="server" MaxLength="12" OnTextChanged="txiIdentityNo_TextChanged" ></asp:TextBox></td>
        </tr>
