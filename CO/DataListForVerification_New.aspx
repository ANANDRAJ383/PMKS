<%@ Page Title="" Language="C#" MasterPageFile="COMasterPage.master" AutoEventWireup="true" CodeFile="DataListForVerification_New.aspx.cs" Inherits="CO_DataListForVerification_New" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">AC Verified  List for Verification of New Application </div><br />
    <div class="row">
...
<div class="form-row">
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
            ...
            <Columns>
               ...
               <asp:BoundField  DataField="AC_ActionDate" HeaderText="AC Verify Date" />
  ...
  <table class="table-bordered table table-striped " style="width: 100%; background-color :aqua" align="center" id="tblBulk" runat="server" visible="false" >
        <tr>
            <td >सत्यापन बिंदु</td>        
