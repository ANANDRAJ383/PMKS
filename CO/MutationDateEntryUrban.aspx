<%@ Page Title="" Language="C#" MasterPageFile="COMasterPage.master" AutoEventWireup="true" CodeFile="MutationDateEntryUrban.aspx.cs" Inherits="CO_MutationDateVerification" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">Entry Mutation Date & Verify Application Urban Data (Return from Indian Government)</div><br />
