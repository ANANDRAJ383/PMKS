...
public partial class CO_DownloadVerifiedData : System.Web.UI.Page
{
    ...
    void DownloadData()
    {
        try
        {
            ...
            objcls.storeProcedure.FieldValue = new object[] { Convert.ToString(Session["DistrictCode"]), ddlBlock.SelectedValue.Trim().ToString(), ddlPanchayat.SelectedValue,1,ddlApplicationType.SelectedValue,ddlStatus.SelectedValue };
            DataTable dt = objcls.storeProcedure.getData();
