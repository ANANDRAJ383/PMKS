...
public partial class CO_PMKNEW : System.Web.UI.Page
{
    ...
    protected void bnSave_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd.CommandText = @"update Registration_PMKISAN_New set LandMutationDate=@LandMutationDate,CO_ActionName=@CO_ActionName,CO_ActionDate=getdate(),CODocVerify=@CODocVerify,CODocRecent=@CODocRecent,COApprove=@COApprove,CO_Status=@CO_Status where  Registration_ID=@Registration_ID ";
