...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold; background-color: #5ed07c; padding: 5px; width: 100%;"
        align="center">
        Application Status
    </div>
    <br />
    <table class="table-bordered  table table-striped ">
        ...
        <tr>
            ...
            <td class="text-center">
                <asp:Label ID="lbldisplay" runat="server" Text="कृषि विभाग, बिहार सरकार" Font-Size="X-Large" Font-Bold="True" Font-Underline="False"></asp:Label>
                <br />
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <h4>Enter Registeration Id</h4>
        </div>
        <div class="col-sm-12">
            <asp:TextBox ID="txtRegId" runat="server" MaxLength="13" class="form-control" placeholder="Enter Registeration Id"></asp:TextBox>
        </div>
        <div class="col-sm-12">
            <asp:Button ID="btnGet" runat="server" Text="Search" class="btn btn-success btn-block" OnClick="btnGet_Click" />
        </div>
    </div>
    ...
    <div>
        ...
        <table class="table-bordered  table table-striped " style="width: 100%;" id="tblRemarks" runat="server" visible="false">
            ...
            <tr id="td1" runat="server">
                ...
                <td>
                    <asp:Label ID="lbl1" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td2" runat="server">
                <td>आवेदक किसान के अलावा कोई अन्य परिवार के सदस्य योजना का लाभ ले रहे हैं ?</td>
                <td>
                    <asp:Label ID="lbl2" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td3" runat="server">
                ...
                <td>
                    <asp:Label ID="lbl3" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td4" runat="server">
                ...
                <td>
                    <asp:Label ID="lbl4" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td5" runat="server">
                ...
                <td>
                    <asp:Label ID="lbl5" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td6" runat="server">
                ...
                <td>
                    <asp:Label ID="lbl6" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td7" runat="server">
                <td>आवेदक किसान परिवार रैयत नहीं है एवं किसान के पास खेती करने योग्य भूमि है |</td>
                <td>
                    <asp:Label ID="lbl7" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td8" runat="server">
                <td>आवेदक का जमीन टोपो लैंड/वासगीत पर्चा/सरकारी भूमि या आबादी की भूमि  है|</td>
                <td>
                    <asp:Label ID="lbl8" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="td9" runat="server">
                <td>आवेदक योजना के अपात्रता की शर्तों में आते हैं एवं योजना की पात्रता नहीं रखते हैं|</td>
                <td>
                    <asp:Label ID="lbl9" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
        ...
        <table class="table-bordered  table table-striped " style="width: 100%;" id="tblCORemarks" runat="server" visible="false">
            ...
            <tr id="Tr1" runat="server">
                ...
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="Tr2" runat="server">
                <td>जमीन दस्तावेज अद्यतन यानि वर्ष (2018-19-20-21-22) का नहीं हैं |</td>
                <td>
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
            <tr id="Tr3" runat="server">
                <td>आवेदन पर अनुमोदन नहीं दिया जा सकता है|</td>
                <td>
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="10" ForeColor="red"></asp:Label></td>
            </tr>
