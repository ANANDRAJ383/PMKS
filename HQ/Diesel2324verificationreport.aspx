<%@ Page Title="" Language="C#" MasterPageFile="ADM.master" AutoEventWireup="true" CodeFile="Diesel2324verificationreport.aspx.cs" Inherits="HQ_Diesel2324" EnableEventValidation = "false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div style="font-family: Cambria; font-size: 22px; color:white; font-weight: bold;
        background-color: #1C6794; padding: 5px; margin-top: 5px; width: 100%;" align="center">Download Diesel Subsidy District Wise Data 2023-24:- <asp:Label ID="lblDistrict" runat="server"></asp:Label></div><br />
