<%@ Page Title="" Language="C#" MasterPageFile="MasterPagePublic.master" AutoEventWireup="true" CodeFile="Re_ReconsiderPMKIsanYojna.aspx.cs" Inherits="PMKIsanYojna" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <table class="table-bordered table-responsive table table-striped " style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="13" class="form-control"></asp:TextBox>

                </td>

                <td align="left">&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="Search" OnClick="Button1_Click" class="btn btn-success" />
                </td>
            </tr>
 ...
 <table>
              <tr>
            <td   >
               <asp:Label ID="lblMsgnew" runat="server" Text=" ** कृपया 13 अंको का किसान पंजीकरण संख्या बॉक्स में प्रविष्टि करें| " class="label label-danger" Font-Bold="true"  ></asp:Label> </td>
            </tr>
        </table>
<table>
</table>
...
<td>
    ...
    ** राजस्व एवं भूमि सुधार विभाग के राजस्व अभिलेख में दर्ज सूचनाएँ के अनुसार आप अपने जमीन की विवरणी दर्ज करें | यह सुनिश्चित करें के आपके ही नाम से आपका जमाबंदी कायम है | जमाबंदी आवेदक के नाम से नहीं पाये जाने पर आवेदन रद्द कर दिया जाएगा | </br>
    </strong>
    <br>
    
    <strong>** आवेदन से पूर्व यह सुनिश्चित कर लें कि आपके आलवा आपके परिवार से कोई अन्य सदस्य इस योजना का लाभ नहीं ले रहें हैं | </strong>
    <br>
    
    <strong>** आवेदन से पूर्व योजना के दिशा निर्देश एवं पात्रता संबन्धित विवरणी जरूर पढ़ लें | दिशा निर्देश एवं पात्रता से संबन्धित दस्तावेज़ पोर्टल पर &quot;उपयोग पुस्तिका&quot; मेनू में उपलब्ध है |</strong><br>
    ...
    <br>1.2 आवेदन में आवेदक का नाम और बैंक अकाउंट में दिये गये आवेदक के नाम भिन्न होना- किसान को अपने बैंक शाखा जा कर बैंक में अपना नाम आधार और आवेदन में दिये गए नाम के अनुरूप करना होगा।
    <br>1.3 IFSC कोड लिखने में त्रुटि।
    <br></br>
    ...
    <br>1.6 राजस्व गाँव के नाम में त्रुटि।
        <br />उपर्युक्त सभी प्रकार की त्रुटियों में सुधार के लिए आधार सत्यापन जरूरी है। अतः मैं प्रधानमंत्री किसान सम्मान योजना आवेदन के त्रुटियों में आवश्यक सुधार करने के लिए आधार सत्यापन की अनुमति देता/देती हूँ।
    <br>## बायोमेट्रिक आधार सत्यापन के लिए किसान अपने निकटतम CSC/वसुधा केंद्र/ सहज केंद्र से संपर्क करें।
</br>
        ...
        <div class="panel panel-success">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlAreaType" runat="server" Width="150px"  class="btn btn-default dropdown-toggle">
                ...
                <td>
                    <%--<asp:UpdatePanel ID="upd11" runat="server" >
                        <ContentTemplate >--%>
                    <asp:DropDownList ID="ddlKisanType" runat="server" Width="150px"  class="btn btn-default dropdown-toggle">
                      
                        <asp:ListItem Text="रैयत किसान"  Value="1" Selected="True"></asp:ListItem>
...
<%--<tr>
    <td colspan="2">   <asp:Label ID="Label1" runat="server" Text=" ** कृपया किसान के प्रकार के चयन में साबधानी बरतें| चयन के बाद बदलाब संभव नहीं है| " class="label label-danger" ></asp:Label> </td>
          ...
          <div class="panel panel-success">
          <div class="panel-heading" style="color:red; font-size:20px; font-weight:bold;"><asp:Label ID="lblApplicantName" runat="server" Font-Size="20px"></asp:Label> &nbsp; अपने परिवार का विवरण दर्ज करें <div style="font-family:Verdana; color:blue;">(गलत विवरण दर्ज किये जाने पर आप योजना से वंचित किये जाएंगे, आपके ऊपर दंडात्मक कारवाई की जाएगी एवं प्राप्त राशि की वशूली भी की जाएगी | )</div></div>
           <div class="panel-body" style="font-size:12px;">

          
                <table class="table-bordered table-responsive table table-striped " style="width: 100%;" align="center">
                    <tr>
                        <td style="font-size:15px;" >सदस्य का संबंध <asp:DropDownList ID="ddlRelation" runat="server" width="130px" Font-Names="Verdana" Font-Size="14px" 
                        ...
                        <td style="font-size:15px;">जीवित/मृत <asp:DropDownList ID="ddlRelativeLive" runat="server" width="130px" Font-Names="Verdana" Font-Size="14px" 
                        ...
                        <td style="font-size:15px;">आधार नंबर <asp:TextBox ID="txtAadhaarR" OnTextChanged="txtAadhaarR_OnTextChanged" AutoPostBack="true" runat="server" Width="150px" 
                                        onkeypress="return validate(event)" class="form-control" MaxLength="12"></asp:TextBox></td>
                       
                        <td style="font-size:15px;">नाम (आधार के अनुसार) <asp:TextBox ID="txtNameR"  runat="server"    class="form-control"  ></asp:TextBox></td>
                       
                        <td align="right" style="font-size:15px;">जन्म की तारीख (आधार के अनुसार) <asp:TextBox ID="txtDobR"  runat="server"   class="form-control"  MaxLength="10" ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td></td>
                         <td></td>
                        <td colspan="2"> <asp:Button ID="ButtonAddR" runat="server" Text="Add New Member" OnClick="ButtonAddR_Click"  class="btn btn-success" visible="false" /></td>
                    </tr>
                </table>
               ...
               <asp:GridView ID="gvView" AutoGenerateColumns="False" runat="server" class="table table-bordered" DataKeyNames="AadhaarNo_FamilyMember">
           ...
           <asp:TemplateField HeaderText="Member Status">
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    ...
                    <div class="panel panel-success">
          <div class="panel-heading" style="color:red; font-size:15px; font-weight:bold;">राजस्व एवं भूमि सुधार विभाग के राजस्व अभिलेख में दर्ज सूचनाएँ के अनुसार आप अपने जमीन की विवरणी दर्ज करें | यह सुनिश्चित करें के आपके ही नाम से आपका जमाबंदी कायम है | जमाबंदी आवेदक के नाम से नहीं पाये जाने पर आवेदन रद्द कर दिया जाएगा | </div>
                      <div class=" col-lg-12 col-md-12 float-center" style="color:red;">
                                        
                                        <a href="http://biharbhumi.bihar.gov.in/Biharbhumi/ViewJamabandi.aspx" target="_blank">  <b style="color:blue;">**अपनी जमाबंदी पंजी की भाग संख्या एवं&nbsp; पृष्ट संख्या पता नहीं होने की स्थिति मे क्लिक करें | </b></a> <br />
                                        <hr style="margin-top:1px; margin-bottom:1px;"  />
                                    </div>
                        <div class="panel-body" style="font-size:12px;">

                    <div class="row" style="text-align: left !important" id="LandSearch" runat="server" >
                                    <div class=" col-lg-12 col-md-12">
                                        
                                        <hr style="margin-top:1px; margin-bottom:1px;"  />
                                    </div>
                                     <div class=" col-lg-3 col-md-3" style="font-size:15px;">
                                        <b>जिला:[*] </b>
                                    ...
                                    <div class=" col-lg-3 col-md-3" style="font-size:15px;">
                                        ...
                                        <asp:DropDownList ID="ddlMauja" CssClass="form-control" runat="server" Style="height: 35px"
                                            Enabled="true" OnSelectedIndexChanged="ddlMauja_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                    ...
                                    <div class=" col-lg-3 col-md-3" style="font-size:15px;">
                                        <b style="font-size: 14px;">जमाबंदी पंजी की भाग संख्या :[*] </b>
                                    ...
                                    <div class=" col-lg-3 col-md-3" style="font-size:15px;">
                                        <b style="font-size: 14px;">जमाबंदी पंजी की पृष्ट संख्या :[*] </b>
                                    ...
                                    <div class=" col-lg-3 col-md-3">
                                        <br />
                                        <asp:Button ID="btnLandDetail" runat="server" ValidationGroup="c" Text="*जमीन का विवरण खोजें" ToolTip="जमीन का विवरण जोड़ें" class="btn btn-success"
                                            OnClick="btnLandDetail_Click" />
                                    </div>

                            
                                    
                                </div>
   <div class="panel-heading" style="color:blue; font-size:15px; font-weight:bold;">**राजस्व एवं भूमि सुधार डाटाबेस में आपके जमीन का डाटा होना अनिवार्य है| यदि डाटा सर्च करने पर प्रदर्शित नहीं हो रहा हो तब राजस्व एवं भूमि सुधार विभाग या अपने अंचल अधिकारी से संपर्क करें |</div>
                    <asp:Panel ID="pnlLandArea" runat="server" Visible="false" >
                                    <br /><br />
                 
                        <asp:GridView ID="grdLand" runat="server" class="table table-bordered" HeaderStyle-Font-Size="15px"></asp:GridView>
                      ...
                      <asp:Panel ID="pnl1xx" runat="server" Visible="false" >   
                    <div class="panel panel-success">
    ...
    <div class="panel-heading"  style="color:red; font-size:15px; font-weight:bold;">आवेदन की शर्तें </div>
         ...
         <ul align="left">
            <li> <b>मै प्रमाणित करता/करती हूँ कि मेरे परिवार (पति, पत्नी और अवयस्क सदस्य) में :  </b> <br />
                1. परिवार के पास खेती योग्य भूमि एवं परिवार के नाम से जमाबंदी भूमि एवं राजस्व विभाग के डाटाबेस में कायम है|<br />
           ...
           <tr>
             ...
             <tr>
                  ...
                  <td valign="top" >
                   ...
                   <td valign="top" >
                       मैं अपना आधार नंबर एवं अन्य सूचनायें इस योजना में पात्रता साबित करने एवं सत्यापन के लिए उपयोग में लाने हेतु अनुमति देता/देती हूँ | 
                   </td>
              ...
              <tr>
                  ...
                  <td valign="top" >
                   ...
                   <td valign="top" >
                       मेरे द्वारा आवेदन में दिया गया &quot;नाम&quot; और जन्म तिथि आधार में दर्ज डाटा के अनुसार सही है। 
                   </td>
       ...
       <%-- </asp:Panel>--%>
        ...
        <asp:Panel ID="pnlSubmit" runat="server" Visible="false">
             <div class="panel panel-success">
            <div class="panel-heading">भूमि का दस्तावेज (250KB in PDF Format Only) </div>
            <div class="panel-body" >
                <center>   
                    <table class="table table-bordered">
                      <tr> 
                          <td align="center"  style="font-size:15px; font-weight:bold;">
                      ** भूमि दस्तावेज़ अद्यतन(वर्ष 19-20/20-21/21-22) होना अनिवार्य है | अद्यतन नहीं होने की स्थिति मे आवेदन रद्द कर दिया जाएगा |<br /><br />
