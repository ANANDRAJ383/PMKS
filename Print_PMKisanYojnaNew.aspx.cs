...
public partial class Print_PMKisanYojnaNew : System.Web.UI.Page
{
    string Appid = "";
  ...
  clsDataAccessNew clsNew = new clsDataAccessNew();
    ...
    protected void FillDetails(String AppId)
    {
       // try
       // {
            DataTable dtt = clsNew.GetDataTable("Select *,  N'रैयत किसान'  fMTYPE from Registration_PMKISAN_New where Registration_ID='" +  Appid + "'");
            ...
            if (dtt.Rows.Count > 0)
            {
                ...
                if (rbApp.SelectedValue == "N")
                {
                    query = @"SELECT top 1   Registration.Registration_ID,   Registration.BankName, Registration.AccountNumber,Registration.IFSC_Code, Registration.Farmer_FName, Registration.Farmer_LName,
                            ...
                            where Registration.Registration_ID='" + AppId + "'  and rp.ApplicationType='NEW'";
                }
                if (rbApp.SelectedValue == "RE")
                {
                    query = @"SELECT top 1   Registration.Registration_ID,   Registration.BankName, Registration.AccountNumber,Registration.IFSC_Code, Registration.Farmer_FName, Registration.Farmer_LName,
                            ...
                            Panchayat ON Registration.PanchayatCode = Panchayat.PanchayatCode 
                            left outer join village v on v.villcode=Registration.villagecode
                            where Registration.Registration_ID='" + AppId + "'  and rp.ApplicationType='RECON'";
                }
                if (rbApp.SelectedValue == "RERE")
                {
                    query = @"SELECT top 1   Registration.Registration_ID,   Registration.BankName, Registration.AccountNumber,Registration.IFSC_Code, Registration.Farmer_FName, Registration.Farmer_LName,
                            ...
                            Panchayat ON Registration.PanchayatCode = Panchayat.PanchayatCode 
                            left outer join village v on v.villcode=Registration.villagecode
                            where Registration.Registration_ID='" + AppId  + "'   and rp.ApplicationType='RE-RECON'";
                }
