<%@ Page Title="" Language="C#" MasterPageFile="PublicMasterPage.master" AutoEventWireup="true" CodeFile="AppStatus.aspx.cs" Inherits="Public_AppStatus" %>
    ...
    <table class="table-bordered  table table-striped " style="width: 100%;"> 
       ...
       <tr>
        ...
        <tr>
            ...
            <td><span>किसान का प्रकार | Farmer type :-</span></td>
            <td style="color: #FF0000; font-size: large">
