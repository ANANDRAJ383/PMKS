<%@ Page Title="" Language="C#" MasterPageFile="PublicMasterPage.master" AutoEventWireup="true" CodeFile="Print_PMKisanYojna.aspx.cs" Inherits="Print_PMKisan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <center>
    <table class="table-bordered table-responsive table table-striped " style="width:100%">
            <tr style="width:100%">
<td>
    <%--<asp:RadioButton ID="RadioButton1" runat="server" Text="नए आवेदन" />
     <asp:RadioButton ID="RadioButton2" runat="server" Text="पुनर्विचार आवेदन" />
     <asp:RadioButton ID="RadioButton3" runat="server" Text="पुनर्विचार मे रद आवेदन पर पुनः विचार" />--%>
...
<asp:GridView ID="grdLand" runat="server"  AutoGenerateColumns="false" CssClass="table table-bordered  table-striped" >
              <Columns>
                  ...
                  <asp:BoundField HeaderText="जिला का नाम" DataField="Dist_Name" HeaderStyle-Font-Size="12px"/>
                   <asp:BoundField HeaderText="राजस्व अंचल" DataField="Circle_Name" HeaderStyle-Font-Size="12px" />
                   <asp:BoundField HeaderText="हलका" DataField="Halka_Name" HeaderStyle-Font-Size="12px"/>
                   <asp:BoundField HeaderText="मौजा" DataField="Mauja_Name" HeaderStyle-Font-Size="12px"/>
                   <asp:BoundField HeaderText="भाग संख्या" DataField="VolumeNo" HeaderStyle-Font-Size="12px" />
                   <asp:BoundField HeaderText="पृष्ट संख्या" DataField="PageNo" HeaderStyle-Font-Size="12px" />
                   <asp:BoundField HeaderText="खाता नंबर" DataField="khata_no" HeaderStyle-Font-Size="12px" />
                  <asp:BoundField HeaderText="खेसरा नंबर" DataField="KhesraNo" HeaderStyle-Font-Size="12px"/>
                   <asp:BoundField HeaderText="एकड़" DataField="LandAker" HeaderStyle-Font-Size="12px"/>
                   <asp:BoundField HeaderText="डिसमील" DataField="LandDismil" HeaderStyle-Font-Size="12px" />
                   <asp:BoundField HeaderText="खाताधारी का नाम" DataField="OwnerName" HeaderStyle-Font-Size="12px" />
              </Columns>
          </asp:GridView>
      <div class="panel-body" style="font-size:12px;">
      ...
      <div class="panel-body" style="font-size:12px;">
          <asp:GridView ID="gvFamilyView" AutoGenerateColumns="False" runat="server" CssClass="table table-bordered  table-striped">
