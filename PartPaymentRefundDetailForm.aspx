<%@ Page Title="" Language="C#" MasterPageFile="MainSite.master" AutoEventWireup="true" CodeFile="PartPaymentRefundDetailForm.aspx.cs" Inherits="DAO_RefundDetailForm" %>
				...
				<div class="form-group">
					<label class="control-label" ><b>वापसी का खाता</b> <span class="mandatory">*</span></label>         
                     ...
                     <asp:DropDownList ID="ddlPaymentType" runat="server" CssClass="form-select" >
                        ...
                        <asp:ListItem Value="Rajy Kosh">राज्य कोष खाता संख्या (40903138323, IFSC: SBIN0006379)</asp:ListItem>                       
