<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="DashBoardNew.aspx.cs" Inherits="DashBoardNew" %>
					    ...
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		...
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"> <asp:Label ID="lbl1" runat="server"  Text =""></asp:Label> </h3>
					    ...
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		...
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"><asp:Label ID="Label1" runat="server"  Text =""></asp:Label></h3>
					        		<div class="text-left" style="margin: 10px 0px 5px;">
					    ...
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		...
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"><asp:Label ID="Label2" runat="server"  Text =""></asp:Label></h3>
					        		<div class="text-left" style="margin: 10px 0px 5px;">
