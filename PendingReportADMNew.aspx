<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="PendingReportADMNew.aspx.cs" Inherits="PendingReportADMNew" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="container-fluid">
                    <div class="d-flex clearfix mt-4">
                        <h3 class="d-inline-block" style="font-size: 32px;">ADM Pending Report-Reconsidert District Wise </h3>
    ...
    <%--<table class="table table-bordered mt-3">
        <tr><a href="PendingReportADM.aspx">PendingReportADM.aspx</a>
            <td>
                Pending Level
            </td>
            <td>
