<%@ Page Title="" Language="C#" MasterPageFile="MasterPagePublic.master" AutoEventWireup="true" CodeFile="PMKisanReconsiderStatus.aspx.cs" Inherits="PMKisanReconsiderStatus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    
        <div class="panel-heading" style="font-family: Verdana; font-weight: bold; font-size: 18px; color: green;" align="center">Check Application Status for PM-KISAN(Reconsider)</div>
