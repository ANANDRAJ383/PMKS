<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="PanchayatWiseRecoveryDaileyEntryReport.aspx.cs" Inherits="Reconcile_DAO_TargetEntryReport" %>
                ...
                <div class="card card-raised h-100">
                    <div class="card-header bg-transparent px-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="me-4">
                                <h2 class="card-title mb-0"><b>Panchayat Wise/ Day Wise Enty Report </b>
                    ...
                    <div class="row mb-3 m-5">
                        ...
                        <div class="col-12 col-sm-3 col-md-3 mb-3">
                            <div class="form-group">
                                <label class="control-label"><b>Reason</b><span class="mandatory">*</span> </label>
                        ...
                        <div class="m-1" style="overflow-x:scroll;">
                            ...
                            <asp:GridView ID="gvdata" runat="server" Width="100%" CssClass="table table-bordered table-striped"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NoOfFarmersR" HeaderText="No Of Farmers Entry" />
                                    <asp:BoundField DataField="NoOfInstallmentsR" HeaderText="No Of Installments Enty" />
