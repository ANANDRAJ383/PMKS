<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="ReConcileDaileyEntryReport - Copy.aspx.cs" Inherits="Reconcile_DAO_TargetEntryReport" %>
                ...
                <div class="card card-raised h-100">
                    <div class="card-header bg-transparent px-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="me-4">
                                <h2 class="card-title mb-0"><b>Reconcile Day Wise Enty Report </b>
                    ...
                    <div class="row mb-3 m-5">
                        ...
                        <div class="m-1" >
                            ...
                            <asp:GridView ID="gvdata" runat="server" Width="100%" CssClass="table table-bordered table-striped"
                                AutoGenerateColumns="False" OnPreRender="gvdata_PreRender" onpageindexchanging="gvdata_PageIndexChanging" AllowPaging="false" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NoOfInstallments" HeaderText="NoOfInstallments to Recovery" Visible="false"/>
                                    ...
                                    <asp:BoundField DataField="NoOfInstallmentsR" HeaderText="NoOfInstallments Enty" Visible="false" />
                                    ...
                                    <asp:BoundField DataField="PmAc" HeaderText="प्रसानिक मद-खाता संख्या (38269533475, IFSC: SBIN0006379)" />
