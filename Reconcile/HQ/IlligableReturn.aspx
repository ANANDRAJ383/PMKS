<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="IlligableReturn.aspx.cs" Inherits="DAO_ITR_Return" %>
                ...
                <td>
                     <asp:RadioButtonList ID="ddlPaymentType" runat="server" >
                        ...
                        <asp:ListItem Text="SLBC/BANK द्वारा वसूली" Value="3"></asp:ListItem>
                            <asp:ListItem Value="2">प्रसानिक मद-खाता संख्या (38269533475, IFSC: SBIN0006379)</asp:ListItem>
