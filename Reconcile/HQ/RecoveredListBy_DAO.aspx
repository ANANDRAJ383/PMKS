<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="RecoveredListBy_DAO.aspx.cs" Inherits="HQ_RecoveredListBy_DAO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div style="font-family: Cambria; font-size: 18px; color: #000; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center"> PM Kisan Recovery List by DAO</div><br />
        ...
        <asp:GridView ID="gvdata" runat="server" CssClass="table table-bordered table-striped"
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="दस्तावेज़">
                ...
                <ItemTemplate>
                    <asp:Button ID="btnViewDetail" Text="Approved" runat="server" OnClick="btnViewDetail_Click" class="btn btn-success"/>
                </ItemTemplate>
            </asp:TemplateField>
                 <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:Button ID="btnBackDAO" Text="Back" runat="server" OnClick="btnBackDAO_Click" class="btn-info"/>
                </ItemTemplate>
            </asp:TemplateField>
            </Columns>
            <RowStyle />
