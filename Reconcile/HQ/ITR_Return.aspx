<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="ITR_Return.aspx.cs" Inherits="DAO_ITR_Return" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div style="font-family: Cambria; font-size: 18px; color: #000; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">पी० एम० किसान (अयोग्य आयकर दाता किसान)<br />भुगतान वापस करने हेतु विपत्र </div><br />
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="false">
     ...
     <div class="panel-heading" style="font-size:12px; font-weight:bold;">Personal Information </div>
      ...
      <table class="table-bordered  table table-striped " style="width: 100%;">
          <tr>
               <td>District</td>
              <td><asp:DropDownList ID="ddlDist" runat="server" CssClass="form-select" ></asp:DropDownList></td>
              <td>
                  Registration No.:
              </td>
              <td >
