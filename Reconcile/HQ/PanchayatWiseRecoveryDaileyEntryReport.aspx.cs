...
public partial class Reconcile_DAO_TargetEntryReport :  System.Web.UI.Page
{
    ...
    void BindData()
    {
        ...
        { 
            ...
            objcls.storeProcedure.NewStoreProcedure("SP_Get_DayWiseRecoverEntryReport_PanchayatWise");
            objcls.storeProcedure.FieldName = "FromDate,ToDate,Reason";
            objcls.storeProcedure.FieldValue = new object[] {txtDate.Text, txtToDate.Text,ddlReason.SelectedValue};
