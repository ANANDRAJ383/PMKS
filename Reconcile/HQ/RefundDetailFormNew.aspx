<%@ Page Title="" Language="C#" MasterPageFile="ADMMasterPage.master" AutoEventWireup="true" CodeFile="RefundDetailFormNew.aspx.cs" Inherits="DAO_RefundDetailForm" %>
                            ...
                            <div class="card card-raised h-100">
                                <div class="card-header bg-transparent px-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-4">
                                            <h2 class="card-title mb-0"><b>रिफंड विवरण भरें</b></h2>
                                        </div>
        ...
        <div id="divData" runat="server" visible="false"  >       
            ...
            <div class="col-12 col-sm-3 col-md-3  mb-3">
                <div class="form-group">
                    ...
                    <asp:CheckBoxList ID="ddlInstallments" runat="server" CssClass="form-control" RepeatDirection="Horizontal" 
                        AutoPostBack="true" OnSelectedIndexChanged="ddlInstallments_SelectedIndexChanged">
                    </asp:CheckBoxList>
                </div>
					</div>
            ...
            <div class="col-12 col-sm-3 col-md-3  mb-3">
				<div class="form-group">
                    ...
                    <asp:TextBox ID="txtReturnAmount" runat="server" CssClass="Disabled form-control" Text="0"  ReadOnly="true" ></asp:TextBox>
				</div>
       ...
       // $('#txtDate').attr('max', minDate);
        ...
        <script type="text/javascript">
            function handleCheckBoxClick(checkbox) {
                ...
                if (checkbox.checked) {
                    alert("Checkbox with value " + checkbox.value + " is checked.");
                    // Add more logic as needed
                } else {
                    alert("Checkbox with value " + checkbox.value + " is unchecked.");
                    // Add more logic as needed
                }
            }
        </script>
