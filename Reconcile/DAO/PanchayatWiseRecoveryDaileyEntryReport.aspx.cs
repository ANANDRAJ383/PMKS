...
public partial class Reconcile_DAO_TargetEntryReport :  System.Web.UI.Page
{
    ...
    void BindData()
    {
        try
        {
            ...
            objcls.storeProcedure.NewStoreProcedure("SP_Get_DayWiseRecoverEntryReport_PanchayatWise_DAOPM");
            objcls.storeProcedure.FieldName = "DistCode";
            objcls.storeProcedure.FieldValue = new object[] { Session["DistrictCode"].ToString()};
