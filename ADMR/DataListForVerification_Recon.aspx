<%@ Page Title="" Language="C#" MasterPageFile="ADMRMasterPage.master" AutoEventWireup="true" CodeFile="DataListForVerification_Recon.aspx.cs" Inherits="ADMR_DataListForVerification_Recon" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">CO Verified  List for Verification of Reconsider Application</div><br />
