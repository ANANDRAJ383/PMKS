<%@ Page Title="" Language="C#" MasterPageFile="ADMRMasterPage.master" AutoEventWireup="true" CodeFile="VerifyedList.aspx.cs" Inherits="CO_VerifyedList" %>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c; padding: 5px; width: 100%;" align="center">ADMR Verified  List  </div><br />
...
<div class="form-row">
        ...
        <asp:GridView ID="gvdata" runat="server" EmptyDataText="No record found" 
            ...
            <Columns>
               ...
               <asp:BoundField  DataField="ADMR_ActionDate" HeaderText="Verify Date" />
