<%@ Page Title="" Language="C#" MasterPageFile="ADMRMasterPage.master" AutoEventWireup="true" CodeFile="DataListForVerification_New.aspx.cs" Inherits="ADMR_DataListForVerification_New" EnableEventValidation="false"%>
...
<div style="font-family: Cambria; font-size: 18px; color: #fff; font-weight: bold;
        background-color: #5ed07c;  width: 100%;" align="center">CO Verified  List for Verification of New Application </div><br />
