<%@ Page Title="" Language="C#" MasterPageFile="MainSite.master" AutoEventWireup="true" CodeFile="RefundDetailForm.aspx.cs" Inherits="RefundDetailForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<tr>
		<td>
            <asp:RadioButtonList ID="rb1" runat="server" RepeatDirection="Horizontal" >
                <asp:ListItem Selected="True" Value="B">पीएम किसान पंजीकरण संख्या (उदाहरण- BR111111111)</asp:ListItem>
                        <asp:ListItem  Value="M">पंजीकृत मोबाइल नंबर</asp:ListItem>
		...
		<div class="row">
			...
			<label>&nbsp;</label>	
                        <asp:Button ID="btnResendOTP" runat="server" Text="Re Send OTP" CssClass="btn btn-success"  Visible="false" OnClick="btnResendOTP_Click" />
                    </div>
				</div>
			</div>
	...
	<div id="divData" runat="server" visible="false" >       
        ...
        <div class="row" id="divEntry" runat="server" visible="false">
			<div class="col-12 col-sm-3 col-md-3">
				<div class="form-group">
        ...
        <div class="row" id="divT" runat="server" visible="false">
			<div class="col-12 col-sm-3 col-md-3">
				<div class="form-group">
					<label class="control-label mb-2" >ट्रांजेक्शन /यूपीआई/यूटीआर नंबर  <span class="mandatory">*</span></label>
                    <asp:TextBox ID="txtUTRNo" runat="server" CssClass="form-control" placeholder="ट्रांजेक्शन नंबर/यूपीआई नंबर/यूटीआर नंबर दर्ज करें !" MaxLength="16"></asp:TextBox>      
            ...
            <div class="col-12 col-sm-3 col-md-3">
             ...
             <div class="col-12 col-sm-3 col-md-3">
				<div class="form-group">
					<label class="control-label mb-2" >ट्रांजेक्शन रसीद अपलोड करें (PDF Only) <span class="mandatory">*</span> </label>
	...
	<div class="col-12 ">
            ...
            <div class="row"  id="dvR" runat="server">
        ...
        <b>क्या आपका राशि बैंक (SLBC) द्वारा काटा गया है ?</b> 
            ...
            <div class="col-12 col-sm-4 col-md-4">
				<div class="form-group">
					<label class="control-label mb-2" >राशि कटने का साक्ष्य अपलोड करें  (PDF Only)</label>
    ...
    <tr>  
     ...
     <tr>  
        ...
        <td><%#Eval("TransactionDate","{0: dd/MM/yyyy}" )%></td>  
                    ...
                    <tr>  
        <td>SLBC Bank Name</td>  
        <td><%#Eval("PaymentReturnACSLBC")%></td>  
    </tr> 
     <tr>  
        <td>SLBC Amount by Bank Deduct</td>  
        <td><%#Eval("SLBCAmount")%></td>  
    </tr> 
    <%-- <tr>  
        <td>Bank TransactionNo</td>  
        <td><%#Eval("SLBC_TransactionNo")%></td>  
    </tr> --%>
     <%--<tr>  
        <td>Bank Transaction Date</td>  
        <td><%#Eval("SLBC_TransactionDate","{0: dd/MM/yyyy}")%></td>  
    </tr> --%>
     <tr>  
        <td>SLBC Bank Account Number</td>  
        <td><%#Eval("SLBCtAc" )%></td>  
    </tr>
                     <tr>  
        <td>SLBC Bank IFSC Code</td>  
        <td><%#Eval("SLBCIfsc" )%></td>  
    </tr>
    <%--<tr>  
        <td>Document</td>  
       ...
       // $('#txtDate').attr('max', minDate);
        ...
        <script type="text/javascript">
            function Validate() {
                ...
                var PayType = document.getElementById("<%=ddlPayType.ClientID %>"); 
