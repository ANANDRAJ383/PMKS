...
public class clsDataAccessPMKisanPMKISANDB
{
    ...
    public clsDataAccessPMKisanPMKISANDB()
    {
        getData = new GetData();
        ...
        if (ConnString.Trim().Length == 0)
            ConnString = System.Configuration.ConfigurationManager.ConnectionStrings["conPMKISANDB"].ConnectionString;
