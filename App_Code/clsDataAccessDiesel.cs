...
public class clsDataAccessDiesel
{
    ...
    public clsDataAccessDiesel()
    {
        ...
        if (ConnString.Trim().Length == 0)
            ConnString = System.Configuration.ConfigurationManager.ConnectionStrings["KrishiDBConnectionString"].ConnectionString;
    ...
    {
        string Eurl = "http://aapda.bih.nic.in";
        return Eurl;
    }
