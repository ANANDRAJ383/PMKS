<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="DashBoardReconsider.aspx.cs" Inherits="DashBoardReconsider" %>
...
<div class="container-fluid">
    ...
    <div class="my-5" id="b-homedb">
			...
			<div class="container">
				<h4 class="text-center mb-3 b-latest-data">Reconsider Application Pending-Latest Data</h4>
					...
					<div class="row text-center pl-4" id="sortable-cards">
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		<p class="text-left font-weight-bold" style="font-size: 14px;">Total Pending at DAO Level</p>
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"><a href="PendingReportDAO.aspx"><asp:Label ID="lbl1" runat="server"  Text =""></asp:Label></a>  </h3>
					    ...
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		<p class="text-left font-weight-bold" style="font-size: 14px;">Total Pending at ADM Level-1</p>
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"><a href="PendingReportADMRE.aspx"><asp:Label ID="Label1" runat="server"  Text =""></asp:Label></a> </h3>
					        		<div class="text-left" style="margin: 10px 0px 5px;">
					    ...
					    <div class="col-lg-6 col-sm-12 p-3 b-customize">
					        <div class="bg-light p-4 b-dbcard">
					        	...
					        	<div class=""> 
					        		<p class="text-left font-weight-bold" style="font-size: 14px;">Total Pending at ADM Level-II</p>
					        		<h3 class="text-left font-weight-bold" style="margin-top: -5px"><a href="PendingReportADMNew.aspx"><asp:Label ID="Label2" runat="server"  Text =""></asp:Label></a> </h3>
					        		<div class="text-left" style="margin: 10px 0px 5px;">
					        			<span class="badge badge-success">4%</span> 
					        			<span style="font-size:13px;">DAO Approved Data pending at ADM Level</span>
					        		</div> 
					        	</div>
					        </div>
					    </div>
