<%@ Page Title="" Language="C#" MasterPageFile="MasterPagePublic.master" AutoEventWireup="true" CodeFile="CheckApplicationStatus.aspx.cs" Inherits="CheckApplicationStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="table-bordered  table table-striped ">
        ...
        <tr id="trId" runat="server">
            ...
            <td>
                <asp:TextBox ID="txtRegId" runat="server" MaxLength="13" class="form-control" placeholder="Enter Registeration Id"
                    OnTextChanged="txtRegId_TextChanged" AutoPostBack="true" onkeypress="return Validate();"></asp:TextBox>

            </td>

            <td>&nbsp;&nbsp;
                    <asp:Button ID="btnGet" runat="server" Text="Send OTP" class="btn btn-success" OnClick="btnGet_Click" Visible="false" />
            </td>
            <td>
                    <asp:Button ID="btnResendOTP" runat="server" Text="Re Send OTP" class="btn btn-success" OnClick="btnGet_Click" Visible="false" />
            </td>
        </tr>
        ...
        <tr id="trOTP" runat="server" visible="false">
            ...
            <td colspan="2">&nbsp;&nbsp;
                    <asp:Button ID="btnView" runat="server" Text="View" class="btn btn-success" OnClick="btnView_Click" />
            </td>
        </tr>
    </table>
     <div >
